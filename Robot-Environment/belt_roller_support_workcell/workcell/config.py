...
class AssetNames:
    ...
    base_def: str = "base-1"
    bracket_def: str = "Bracket-1"
    bush_def: str = "BUSH-1"
    shaft_def: str = "Shaft-1"

    # assembled steps (illusion)
    as1: str = "Assemble__1_"
    as2: str = "Assemble__2_"
    as3: str = "Assemble__3_"
    as4: str = "Assemble__4_"
    final_product: str = "Belt_Roller_Support"
