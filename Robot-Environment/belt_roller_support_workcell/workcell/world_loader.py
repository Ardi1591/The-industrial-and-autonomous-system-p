...
from workcell.motion.ur10_cartesian import UR10Cartesian
from workcell.motion.ur5_cartesian import UR5Cartesian
...
class WorkcellWorld:
    ...
    def load(self) -> None:
        ...
        self.ur10 = UR10Cartesian("/World/ur10_short_suction")
        self.ur5 = UR5Cartesian("/World/ur5e")
