...
This project is an **OOP Python** implementation for the belt-roller-support workcell described in your PDF:
...
If you want, I can adapt the robot motion to true pick-and-place (RMPflow or joint-space waypoints) once you confirm the exact end-effector prim paths and desired pick/place poses in your scene.
